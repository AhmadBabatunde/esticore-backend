...
class AgentWorkflow:
    ...
    def _create_prompt(self):
        ...
        return ChatPromptTemplate.from_messages([
            ("system", """You are an expert AI assistant for working with floor plan documents. You can both answer questions about the documents and annotate specific pages.
